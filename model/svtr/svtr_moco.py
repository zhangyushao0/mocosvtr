...
class SVTR(BaseModel):
    ...
    def __init__(
        ...
        super(SVTR, self).__init__(data_preprocessor=data_preprocessor, init_cfg=init_cfg)
...
pretrained = "work_dir/moco_epoch_40.pth"
...
SVTRModel = SVTR(
    ...
    init_cfg=dict(type='Pretrained', checkpoint=pretrained, prefix="backbone_q."),
)
